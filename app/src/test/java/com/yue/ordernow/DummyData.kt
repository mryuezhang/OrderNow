...
object DummyData {
    ...
    var order1: Order
    var order2: Order
    var dailySaleSummary = SaleSummary(Report.Type.TODAY)

    init {
        order1 =
            Order.newInstance(arrayListOf(orderItem1, orderItem2), 0f, 0, false, false, "Table 2").apply {
                id = 0
            }
        Thread.sleep(1000)
        order2 = Order.newInstance(arrayListOf(orderItem3, orderItem4), 0f, 0, true, true).apply {
            id = 1
        }
    }
}